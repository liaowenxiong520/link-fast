...
public class ProxyInstance {
    private Long id;
    private String orderNo;       // 平台订单号，非空
    private String appOrderNo;    // 渠道商订单号，非空
    private String instanceNo;    // 平台实例编号，非空
    private Integer proxyType;    // 代理类型，非空
    private String protocol;      // 协议类型
    private String ip;            // 代理地址，非空
    private Integer port;         // 代理端口
    private String regionId;      // 区域地址
    private String countryCode;   // 国家代码，非空
    private String cityCode;      // 城市代码，非空
    private String useType;       // 使用方式，非空
    private String username;      // 使用代理实例的账户名，非空
    private String pwd;           // 使用代理实例的密码，非空
    private Long userId;          // 渠道商系统的买家id，非空
    private Long userExpired;     // 到期时间（时间戳，秒）
    private BigDecimal flowTotal; // 总流量(MB)/IP数，非空
